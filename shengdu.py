...
new Env("shengdu小说")
export shengducks='整条url#提现目标' # 抓https://dj.palmestore.com/zycl/gold/dailyWelfareV5 整条url 请注意signType=1 过新手期改为2
export shengducks='整条url'
并发格式 multi_dj='true'
cron: 8 7,9-21 * * *
"""
import asyncio
